...
const Banner = ({ purpose, imageUrl, title1, title2, desc1, desc2, linkName, buttonText }) => (
  <Flex flexWrap='wrap' justifyContent='center' alignItems='center' m='10'>
    <Image src={imageUrl} width={500} height={300} alt='banner' borderRaduis="2px" />
    <Box p='5'>
      <Text fontSize='sm' fontWeight='medium' color='gray.500'>{purpose}</Text>
      <Text fontSize='3xl' fontWeight='bold' color=''>{title1} <br />{title2}</Text>
...
const Home = ({ propertiesForSale, propertiesForRent }) => {
  console.log(propertiesForSale[0].title);
  return (
    <Box>
      <Banner
        purpose='RENT A HOME'
